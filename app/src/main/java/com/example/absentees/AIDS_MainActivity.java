...
public class AIDS_MainActivity extends AppCompatActivity {
    ...
    private static AttendanceData[] attendanceData = {
            ...
            new AttendanceData("ML", 36, 0, 0, 0),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alamanac = findViewById(R.id.alamanactextaids);

        alamanac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_alamanac = new Intent(AIDS_MainActivity.this, AlmanacActivity.class);
